...
/** Drops entries marked `draft: true` so they never reach a built page or the feed. */
export function getPublished<T extends CollectionEntry<'blog' | 'projects'>>(items: T[]): T[] {
